...
csv_logger = CSVLogger('mnist_0.csv')
model.fit(x_train, y_train, callbacks=[csv_logger] ,batch_size = 256, epochs = 60, validation_data=(x_test, y_test))
