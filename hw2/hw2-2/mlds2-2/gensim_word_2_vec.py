...
model = Word2Vec(corpus, size = 250, iter = 12, sg=0, window=3, min_count=5, max_vocab_size=None, workers=3, min_alpha=0.0001, hs=0, negative=5, batch_words=10000)
model.save('word2vec.model')
#mincount = 1 word2vec.model
#window = 3 word2vec
#window = 2 word2vec_window

#load
#model = Word2Vec.load('word2vec_window.model')
...
print(most_similar(model, ['<bos>','<eos>','鬧夠','瞧','小時']))
